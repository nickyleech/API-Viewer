...
function getDateRange() {
    ...
    function showProgrammeDetail(item) {
        ...
        if (contributors.length > 0) {
            ...
            contToggle.innerHTML = `<input type="checkbox" style="cursor:pointer"> Show Contributors (${contributors.length})`;
        ...
        if (emptyFields.length > 0) {
            ...
            toggleRow.innerHTML = `<label style="display:flex;align-items:center;gap:6px;cursor:pointer;font-size:13px;color:var(--color-text-secondary)"><input type="checkbox" style="cursor:pointer"> Show empty fields (${emptyFields.length})</label>`;
